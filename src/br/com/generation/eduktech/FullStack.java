...
public class FullStack {
	...
	private char opcaoDigitada;
	
	public char getOpcaoDigitada() {
		return opcaoDigitada;
	}

	public void setOpcaoDigitada(char opcaoDigitada) {
	...
	System.out.println("Para mais detalhes digite 1, 2, ou 3 para a opção desejada ou 0 para sair:");opcaoDigitada=new Scanner(System.in).next().charAt(0);
	...
	break;
	case '3':
		System.out.println("Códigos do amanhã - EBANX\n\nEm 6 meses, teremos profissionais prontos para atuar na área de programação Web Dev Fullstack."+ "\n" +"Além da parte técnica com a metodologia de ensino da Resilia, o projeto vai trabalhar diferentes" + "\n" + "habilidades e preparar as alunas e alunos para entrar no mercado de trabalho, com o acompanhamento" + "\n" + "de um time multidisciplinar de profissionais do EBANX dispostos a ajudar nas mais diversas frentes" + "\n" + "de desenvolvimento profissional.");
	break;
	case '0':
